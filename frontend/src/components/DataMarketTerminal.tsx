...
const GLOBAL_TRADES: GlobalTrade[] = [
  {
    jobId: 193,
    timeAgo: "3 h ago",
    datasetName: "NOAA Doppler Radar & Global Weather Telemetry",
    amountUsdc: 0.25,
    outcome: "open",
  ...
  },
  {
    jobId: 192,
    timeAgo: "7 h ago",
    datasetName: "Global Equities & Crypto L2 Order Book Stream",
    amountUsdc: 0.35,
    outcome: "settled",
    txHash: "0x7c10b49ad68e5410982345678901234567890abc",
    blockNumber: 38219447,
    promisedSlaSeconds: 3,
    observedDataAgeSeconds: 1.2,
    buyerAddress: "0x71C839e93a...b1e60",
  },
  {
    jobId: 191,
    timeAgo: "16 h ago",
    datasetName: "Global Macro & Commodities Index Feeds",
    amountUsdc: 0.45,
    outcome: "open",
  ...
  },
  {
    jobId: 190,
    timeAgo: "4 d ago",
    datasetName: "FlightAware Global Aviation & ADS-B Telemetry",
    amountUsdc: 0.30,
    outcome: "settled",
    txHash: "0x6be0f9210ac573b9876543210fedcba987654321",
    blockNumber: 38208124,
    promisedSlaSeconds: 6,
    observedDataAgeSeconds: 2.4,
    buyerAddress: "0x45E923e421...b1e63",
  },
  {
    jobId: 189,
    timeAgo: "5 d ago",
    datasetName: "Polymarket Global Macro & Prediction Curves",
    amountUsdc: 0.60,
    outcome: "settled",
  ...
  },
  {
    jobId: 188,
    timeAgo: "5 d ago",
    datasetName: "Aave V3 Multi-Chain Lending Rates & APY",
    amountUsdc: 0.25,
    outcome: "open",
